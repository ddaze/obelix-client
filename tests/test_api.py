...
from obelix_client.storage import RedisStorage,RedisMock
from obelix_client.queue import RedisQueue
from obelix_client.receivers import ConnectQueueSignals
import json
...
class TestObelix(object):
    ...
    def setup_method(self, method):
        ...
        self.queue_signals = ConnectQueueSignals(self.obelix, self.queues)
        self.queue_signals.connect()
    ...
    def test_obelix_settings_parameter(self):
        ...
        obelix = Obelix(self.cache, self.recommendations, settings)
...
class TestObelixLogging(object):
    ...
    def test_log_search_result(self):
        ...
        logStorage = self.cache.get(storage_key)
